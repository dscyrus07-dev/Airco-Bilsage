  ...
  return (
    <div className="space-y-4 animate-fade-in">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button variant="outline" size="sm" className="gap-1.5" onClick={() => toast.info("Downloading PDF…")}>
            <Download className="h-3.5 w-3.5" /> Download PDF
          </Button>
          <Button variant="outline" size="sm" className="gap-1.5" onClick={() => toast.info("Sending reminder…")}>
        ...
        <div className="space-y-4">
          ...
          <Card className="p-4">
            ...
            <div className="space-y-2">
              ...
              <Button variant="outline" size="sm" className="w-full justify-start gap-2 text-xs" onClick={() => toast.info("Sending reminder email…")}>
                <Send className="h-3.5 w-3.5" /> Send Payment Reminder
              </Button>
              <Button variant="outline" size="sm" className="w-full justify-start gap-2 text-xs" onClick={() => toast.info("Downloading PDF…")}>
