  ...
  return (
    <div className="space-y-4 animate-fade-in">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button variant="outline" size="sm" className="gap-1.5" onClick={() => toast.info("Downloading bill…")}>
            <Download className="h-3.5 w-3.5" /> Download Bill
          </Button>
          <Button variant="outline" size="sm" className="gap-1.5" onClick={() => toast.info("Opening editor…")}>
            <Edit2 className="h-3.5 w-3.5" /> Edit Entry
          </Button>
          <Button size="sm" className="gap-1.5" onClick={() => toast.success("Marked as verified")}>
        ...
        <div className="space-y-4">
          ...
          <Card className="p-4">
            ...
            <div className="rounded-lg bg-muted/30 border-2 border-dashed p-6 flex flex-col items-center text-center mb-3">
              ...
              <p className="text-xs font-medium">{purchase.invoiceNo}.pdf</p>
              <p className="text-[10px] text-muted-foreground mt-0.5">Uploaded document</p>
            </div>
            <div className="space-y-2">
          ...
          <ApprovalPanel
            ...
            onRequestCorrection={(comment) => {
              // Handle correction request logic
              console.log("Correction requested:", comment);
            }}
          ...
          <Card className="p-4">
            ...
            <div className="space-y-3">
              ...
              {purchase.status !== "paid" && purchase.status === "approved" && (
                <Button size="sm" className="w-full gap-1.5 text-xs" onClick={() => toast.info("Opening payment form...")}>
